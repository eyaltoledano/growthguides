...
class GuidesControllerTest < ActionController::TestCase
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post :create, guide: { author: @guide.author, availability: @guide.availability, description: @guide.description, name: @guide.name, price: @guide.price }
    end
  ...
  test "should update guide" do
    patch :update, id: @guide, guide: { author: @guide.author, availability: @guide.availability, description: @guide.description, name: @guide.name, price: @guide.price }
    assert_redirected_to guide_path(assigns(:guide))
  end
